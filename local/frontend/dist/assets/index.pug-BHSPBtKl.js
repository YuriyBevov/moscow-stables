...
var _config = {
  ...
  overwrite: false,
  delay: 0
}, _suppressOverwrites$1, _reverting$1, _context$4, _bigNum$1 = 1e8, _tinyNum = 1 / _bigNum$1, _2PI = Math.PI * 2, _HALF_PI = _2PI / 4, _gsID = 0, _sqrt = Math.sqrt, _cos = Math.cos, _sin = Math.sin, _isString$1 = function _isString(value) {
  ...
  return _context$4 && !scope && _context$4.selector ? _context$4.selector(value) : _isString$1(value) && !leaveStrings && (_coreInitted$4 || !_wake()) ? _slice.call((scope || _doc$4).querySelectorAll(value), 0) : _isArray(value) ? _flatten(value, leaveStrings) : _isArrayLike(value) ? _slice.call(value, 0) : value ? [value] : [];
  ...
  var v = animation.vars, callback = v[type], prevContext = _context$4, context3 = animation._ctx, params, scope, result;
  if (!callback) {
    return;
  }
...
var Context = /* @__PURE__ */ function() {
  ...
  _proto5.add = function add(name, func, scope) {
    ...
    var self = this, f = function f2() {
      var prev = _context$4, prevSelector = self.selector, result;
...
var _gsap = {
  ...
  context: function context(func, scope) {
    return func ? new Context(func, scope) : _context$4;
  },
...
var Observer = /* @__PURE__ */ function() {
  ...
  _proto.init = function init4(vars) {
    _coreInitted$3 || _initCore2(gsap$3) || console.warn("Please gsap.registerPlugin(Observer)");
...
var ScrollTrigger$1 = /* @__PURE__ */ function() {
  ...
  ScrollTrigger2.enable = function enable() {
    ...
    if (gsap$2) {
      ...
      _context$2 = gsap$2.core.context || _passThrough2;
 ...
 * @author: Jack Doyle, jack@greensock.com
*/
var gsap$1, _coreInitted$1, _win, _doc, _docEl, _body, _toArray$1, _clamp2, ScrollTrigger, _mainInstance, _expo, _getVelocityProp2, _inputObserver2, _context$1, _onResizeDelayedCall, _windowExists4 = function _windowExists5() {
  return typeof window !== "undefined";
...
var ScrollSmoother = /* @__PURE__ */ function() {
  function ScrollSmoother2(vars) {
    var _this = this;
    _coreInitted$1 || ScrollSmoother2.register(gsap$1) || console.warn("Please gsap.registerPlugin(ScrollSmoother)");
    vars = this.vars = vars || {};
    ...
    var _vars = vars, smoothTouch = _vars.smoothTouch, _onUpdate = _vars.onUpdate, onStop = _vars.onStop, smooth = _vars.smooth, onFocusIn = _vars.onFocusIn, normalizeScroll = _vars.normalizeScroll, wholePixels = _vars.wholePixels, content, wrapper, height, mainST, effects, sections, intervalID, wrapperCSS, contentCSS, paused, pausedNormalizer, recordedRefreshScroll, recordedRefreshScrub, allowUpdates, self = this, effectsPrefix = vars.effectsPrefix || "", scrollFunc = ScrollTrigger.getScrollFunc(_win), smoothDuration = ScrollTrigger.isTouch === 1 ? smoothTouch === true ? 0.8 : parseFloat(smoothTouch) || 0 : smooth === 0 || smooth === false ? 0 : parseFloat(smooth) || 0.8, speed = smoothDuration && +vars.speed || 1, currentY = 0, delta = 0, startupPhase = 1, tracker = _getVelocityProp2(0), updateVelocity = function updateVelocity2() {
      ...
      var getSpeed = effectValueGetter("speed", speed2, index, el), getLag = effectValueGetter("lag", lag, index, el), startY = gsap$1.getProperty(el, "y"), cache = el._gsap, ratio, st, autoSpeed, scrub, progressOffset, yOffset, pins = [], initDynamicValues = function initDynamicValues2() {
        speed2 = getSpeed();
          ...
          onUpdate: function onUpdate(self2) {
            ...
            if (self2.offset) {
              if (i) {
                ...
                y = startY + extraY + change * ((gsap$1.utils.clamp(self2.start, self2.end, scrollY) - self2.start - extraY) / (end - self2.start) - progressOffset);
              }
    ...
    this.scrollTo = function(target, smooth2, position) {
      var p = gsap$1.utils.clamp(0, _maxScroll2(), isNaN(target) ? _this.offset(target, position, !!smooth2 && !paused) : +target);
      !smooth2 ? scrollTop(p) : paused ? gsap$1.to(_this, {
    ...
    this.content = function(element) {
      if (arguments.length) {
        ...
        if (newContent !== content) {
          ...
          smoothDuration || gsap$1.set(content, {
    ...
    mainST = ScrollTrigger.create({
      animation: gsap$1.fromTo(scroll, {
        y: function y() {
          allowUpdates = 0;
          return 0;
        }
      ...
      onRefresh: function onRefresh2(self2) {
        ...
        if (!startupPhase) {
          ...
          self2.animation.progress(gsap$1.utils.clamp(0, 1, recordedRefreshScroll / speed / -self2.end));
        }
    ...
    "scrollBehavior" in _win.getComputedStyle(_body) && gsap$1.set([_body, _docEl], {
      scrollBehavior: "auto"
    });
  ...
  ScrollSmoother2.register = function register(core) {
    if (!_coreInitted$1) {
      ...
      if (gsap$1) {
        ...
        gsap$1.core.globals("ScrollSmoother", ScrollSmoother2);
        if (_body && ScrollTrigger) {
          _onResizeDelayedCall = gsap$1.delayedCall(0.2, function() {
...
_getGSAP3() && gsap$1.registerPlugin(ScrollSmoother);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const textAnimation = gsapWithCSS.from(split.lines, {
    opacity: 0,
    y: 100,
    duration: 0.5,
    stagger: 0.05,
  ...
  gsapWithCSS.fromTo(
    ...
    },
    {
      ...
      scrollTrigger: {
        trigger: ".hero",
        // элемент, который инициирует анимацию
        start: "top top",
        // когда верх элемента достигнет центра viewport
        end: "+=120%",
        // когда низ элемента достигнет центра viewport
        scrub: true,
        // плавная анимация при скролле
        markers: true,
        // раскомментируйте для отладки (покажет маркеры)
        invalidateOnRefresh: true
      }
    }
  );
  ...
  ScrollTrigger$1.create({
    ...
    onUpdate: (self) => {
      ...
      gsapWithCSS.to(".hero-title img:first-child", {
        x: -window.innerHeight * progress * 2.7,
        opacity: 1 - progress * 1.2,
        ease: "none"
      });
      gsapWithCSS.to(".hero-title img:last-child", {
        x: window.innerHeight * progress * 2.5,
        opacity: 1 - progress * 1.2,
        ease: "none"
      });
      const blurValue = gsapWithCSS.utils.mapRange(0.6, 0.7, 0, 4, progress * 1.2);
      gsapWithCSS.to(".hero-bg img", {
...
function initHorizontalScroll() {
  ...
  gsapWithCSS.set(cardsContainer, {
    x: window.innerWidth
  });
  ScrollTrigger$1.create({
    trigger: section,
